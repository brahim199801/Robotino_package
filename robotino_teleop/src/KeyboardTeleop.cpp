...
void KeyboardTeleop::spin()
{
	...
	puts("la commande du robots par le clavier");
	puts("---------------------------");
	puts("Utiliser '1235' pour les  translations");
	puts("Utiliser 'df' pour les rotation ");

	puts("Utiliser l'espace pour freiner");
